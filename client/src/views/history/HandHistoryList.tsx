    ...
    <div className="fixed inset-0 bg-black/90 z-50 overflow-auto">
      <div className="p-4 max-w-lg mx-auto">
        <div className="flex justify-between items-center mb-4">
          <h2 className="text-white text-xl font-bold">Hand History</h2>
        ...
        {hands.length === 0 ? (
          <p className="text-gray-500 text-center py-8">No hands played yet</p>
        ) : (
              ...
              return (
                ...
                >
                  <div className="flex justify-between">
                    <span className="text-white font-medium">Hand #{hand.handNumber}</span>
                  ...
                  <div className="text-gray-500 text-xs mt-1">
                    {hand.gameType} {hand.blinds.small}/{hand.blinds.big} - {hand.players.length} players
                  </div>
                </button>
              );
            })}
